...
# Define API endpoint to generate code based on the input description and language
...
async def generate_code(request: CodeRequest):
    ...
    try:
        ...
        code = await asyncio.to_thread(generateCodeFromNL, request.description, request.language)
